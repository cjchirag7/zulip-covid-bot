...
BOT_MAIL = "covid-vaccine-bot@chirag-jain.zulipchat.com"
...
class ZulipBot(object):
	def __init__(self):
		self.client = zulip.Client(site="https://chirag-jain.zulipchat.com/api/")
		self.subscribe_all()
	...
	def process(self, msg):
		...
		elif "CovidBot" in content and content[0] != "CovidBot":
			self.client.send_message({
				"type": "stream",
				"subject": msg["subject"],
				"to": msg["display_recipient"],
...
if __name__ == "__main__":
	try:
		...
		print("Thanks for using Covid Bot. Bye!")
		sys.exit(0)
